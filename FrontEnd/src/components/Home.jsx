...
function Home() {
  ...
  return (
    <>
    <div className='max-w-screen-2xl mx-auto container px-6 py-3 md:px-40 bg-cyan-100'>
      <div className='flex h-screen items-center justify-center'>
        <div className='border-2 border-dashed px-4 py-2 md:px-8 md:py-6 border-indigo-400 rounded-lg shadow-lg'>
          <h1 className='text-3xl font-bold text-center mb-4'>Convert your Word Document to PDF</h1>
          <p className='text-sm text-center mb-5'>Instantly transform Word files into secure, shareable PDFs.<br></br>Fast, reliable, and hassle-free Word to PDF conversion. <br></br>Convert documents in one click — no extra software required.</p>
